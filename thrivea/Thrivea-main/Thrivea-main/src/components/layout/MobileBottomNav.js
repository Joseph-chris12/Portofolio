...
export default function MobileBottomNav() {
  ...
  const tabs = [
    {
      ...
      iconFilled: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          <path d="M11.47 3.84a.75.75 0 011.06 0l8.69 8.69a.75.75 0 01-.53 1.28h-1.5v7.38a.75.75 0 01-.75.75h-3a.75.75 0 01-.75-.75v-4.5a.75.75 0 00-.75-.75h-3a.75.75 0 00-.75.75v4.5a.75.75 0 01-.75.75h-3a.75.75 0 01-.75-.75v-7.38h-1.5a.75.75 0 01-.53-1.28l8.69-8.69z" />
        </svg>
      ),
    },
    {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 w-full z-50 bg-white border-t border-outline-variant shadow-lg">
